...
const Room = ({ROOMTYPE, balcony = false, data}: Props) => {
    ...
    switch(ROOMTYPE) {
        ...
        case 2 : return (
            <div className="bg-[#A2C3A4] w-[22%] h-[100%] border-stone-600 border-collapse border-solid border-2 flex flex-col items-center">
                <FontAwesomeIcon icon={faCaretUp} className=" cursor-pointer h-1/2 w-full border-b-2 border-stone-600"/>
                <FontAwesomeIcon icon={faCaretDown} className=" cursor-pointer h-1/2 w-full"/>
            </div>
        )
